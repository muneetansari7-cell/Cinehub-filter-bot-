...
API_ID = int(environ.get("API_ID", "24332123"))
API_HASH = environ.get("API_HASH", "abc2e4ec18e92c57c20e246410f8fb38")
BOT_TOKEN = environ.get("BOT_TOKEN", "8795852939:AAGwucVg7BdhbhFU1Qg70UaE8NPvnMA2CYQ")
PORT = environ.get("PORT", "8082")

# Owners
ADMINS = [
    int(admin) if id_pattern.search(admin) else admin
    for admin in environ.get("ADMINS", "7128786278").split()
]
OWNER_USERNAME = environ.get(
    "OWNER_USERNAME", "Being_Zenin"
...
CHANNELS = [
    ...
    for ch in environ.get("CHANNELS", "-1003897916058").split()
]

# ForceSub Channel & Log Channels
AUTH_CHANNEL = int(environ.get("AUTH_CHANNEL", "-1002231187887"))
AUTH_REQ_CHANNEL = int(environ.get("AUTH_REQ_CHANNEL", "-1002231187887"))
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1003903607513"))
LOG_API_CHANNEL = int(environ.get("LOG_API_CHANNEL", "-1003903607513"))
LOG_VR_CHANNEL = int(environ.get("LOG_VR_CHANNEL", "-1003903607513"))

# MongoDB
DATABASE_URI = environ.get("DATABASE_URI", "mongodb+srv://psychoafx:Muneerrr@cluster0.kucyrkw.mongodb.net/?appName=Cluster0")
DATABASE_NAME = environ.get("DATABASE_NAME", "Cluster0")

# Files index database url
FILES_DATABASE = environ.get("FILES_DATABASE", "mongodb+srv://psychoafx:Muneerrr@cluster0.kucyrkw.mongodb.net/?appName=Cluster0")
COLLECTION_NAME = environ.get("COLLECTION_NAME", "Cluster0")

# Other Channel's
SUPPORT_GROUP = int(environ.get("SUPPORT_GROUP", "-1002231187887"))
DELETE_CHANNELS = int(environ.get("DELETE_CHANNELS", "0"))
request_channel = environ.get("REQUEST_CHANNEL", "-1002231187887")
REQUEST_CHANNEL = (
    int(request_channel)
    if request_channel and id_pattern.search(request_channel)
    else None
)
MOVIE_UPDATE_CHANNEL = int(environ.get("MOVIE_UPDATE_CHANNEL", "-1002231187887"))

# Added Link Here Not Id
SUPPORT_CHAT = environ.get("SUPPORT_CHAT", "https://t.me/+N1FxVNe-SmQyM2Fl")
MOVIE_GROUP_LINK = environ.get("MOVIE_GROUP_LINK", "https://t.me/+N1FxVNe-SmQyM2Fl")
